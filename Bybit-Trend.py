...
class SignalPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, "Bybit Futures Advanced Signals", 0, 1, "C")
...
# === ADVANCED SIGNAL SCORING & ENHANCEMENT (from your posted generator) ===
...
# === SIGNAL ANALYSIS (now using advanced logic) ===
def analyze(symbol):
    data = {}
    for tf in INTERVALS:
...
def main():
    while True:
        print("\n🔍 Scanning Bybit USDT Futures with Advanced Signal Logic...\n")
        ...
        if signals:
            ...
            # Notifications
            send_discord("📊 **Top 5 Advanced Bybit Signals**\n\n" + agg_msg)
            send_telegram("📊 *Top 5 Advanced Bybit Signals*\n\n" + agg_msg)
            print("✅ Notifications sent to Discord & Telegram.\n")
        else:
            print("⚠️ No high-quality signals found (score ≥50%)\n")
